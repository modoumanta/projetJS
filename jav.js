...
//=========================================================
 ...
 let ff1=document.querySelector('.faild1');
 ff1.addEventListener('click',faux);
 let ff2=document.querySelector('.faild2');
 ff2.addEventListener('click',faux1);
 let ff3=document.querySelector('.faild3');
 ff3.addEventListener('click',faux2);
 let ff4=document.querySelector('.faild4');
 ff4.addEventListener('click',faux3);
 let ff5=document.querySelector('.faild5');
 ff5.addEventListener('click',faux4);
 let ff6=document.querySelector('.faild6');
 ff6.addEventListener('click',faux5);
 let ff7=document.querySelector('.faild7');
 ...
 let clea =document.querySelector('.clean');
...
let lett1 =document.querySelector('.lettreB')
...
let lett2 =document.querySelector('.lettreA')
...
res3.append(R13);
let lett3 =document.querySelector('.lettreL1')
...
let lett4 =document.querySelector('.lettreL')
...
res5.append(R15);
let lett5 =document.querySelector('.lettreE')
...
let apre =document.querySelector('.next');
